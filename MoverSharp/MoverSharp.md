...
While it's possible to connect to a wallet running on another machine, for `host_s` this should most likely be the local loopback, i.e. 127.0.0.1 or localhost. Also, note that it does **not** have a trailing `/` because the port will be appended. 
